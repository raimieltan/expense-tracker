'use client'; // This enables client-side rendering in Next.js (for form state handling)
...
const SignupPage = () => {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            router.push('/login'); // Redirect to dashboard or desired page
        } catch (err) {
            console.log(err)
            ...
            <div className="bg-white p-8 rounded shadow-md w-full max-w-md">
                ...
                <div className="mb-4">
                    ...
                    <button
                        ...
                        disabled={loading}
                    >
                        {loading ? 'Registering new user...' : 'Sign up'}
                    </button>
                </form>
            </div>
        </div>
